...
function AnimeClientPage() {
  ...
  useEffect(() => {
    if (!loading) {
      ...
      console.log("Final filtered and sorted anime posters:", filtered.length)
      setAnimePosters(filtered)
    }
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-grow container mx-auto px-4 py-12 text-center">
          ...
          <p className="mt-2">Loading anime posters...</p>
        </div>
        <Footer />
      </div>
    )
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero section with dark brown gradient background */}
      <div className="bg-gradient-to-br from-amber-900 via-black to-amber-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Anime Posters</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-gray-500">
                {animePosters.length} poster{animePosters.length !== 1 ? "s" : ""} found
              </span>
          ...
          {animePosters.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">No anime posters found.</p>
...
export default AnimeClientPage
